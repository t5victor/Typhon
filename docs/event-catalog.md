...
| Settlement process manager | `RequestSettlement` | `SettlementRequested` | A winning company received a specific financial obligation, derived from `WinningBidAccepted`. |
